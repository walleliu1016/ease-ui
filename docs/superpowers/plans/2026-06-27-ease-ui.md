# Ease UI Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build a cross-platform Wails v2 desktop app (Ease UI) that wraps the Claude CLI, providing session management, streaming response UI, PermissionRequest interception, and editable Hook configuration.
...
Run: `go mod init github.com/akke/ease-ui`

Expected: Creates `go.mod` with `module github.com/akke/ease-ui` and `go 1.22`.
...
Run:
```bash
wails init -n ease-ui -t vue-ts -d .
```
...
### Task 23: Implement ease-ui init CLI
...
Run:
```bash
go build -o /tmp/ease-ui-test .
/tmp/ease-ui-test init
```
...
git commit -m "feat(cli): add ease-ui init subcommand for first-time setup"
```
  ...
  <div class="uninit">
    ...
    <div class="uninit-body">
      <div class="card">
        ...
        <pre class="cmd">ease-ui init</pre>
...
Plan complete and saved to `docs/superpowers/plans/2026-06-27-ease-ui.md`. Two execution options:
